...
- **Documentation**: Crate documentation now includes full README content via `include_str!`
- **Documentation**: Added "Code Reference" section with algorithm selection guide, performance tables, and working examples
- **docs.rs**: Configured to build with `std` and `concurrent` features for complete API documentation

### Fixed

- Fixed broken LICENSE link in README that caused rustdoc warnings
- Fixed README code examples for doctest compatibility
